...
export const CommentService = Symbol('CommentService');
...
@injectable()
export class PluginCommentService implements CommentService {
	...
	private readonly _onDidUpdateCommentThreads: Emitter<CommentThreadChangedEvent> = new Emitter<CommentThreadChangedEvent>();
	...
	updateComments(ownerId: string, event: CommentThreadChangedEvent): void {
		const evt: CommentThreadChangedEvent = Object.assign({}, event, { owner: ownerId });
